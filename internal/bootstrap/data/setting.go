...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "Seedbx-File", Type: conf.TypeString, Group: model.SITE},
		{Key: conf.Announcement, Value: "### Join CiV3 Discord Server\nhttps://discord.gg/DAvhENGyXU", Type: conf.TypeText, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://i.postimg.cc/j5TnMr19/u-Torrent-Logo-small.png", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://i.postimg.cc/j5TnMr19/u-Torrent-Logo-small.png", Type: conf.TypeString, Group: model.STYLE},
