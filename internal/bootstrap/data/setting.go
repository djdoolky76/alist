...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		// style settings
		{Key: conf.Logo, Value: "https://i.postimg.cc/rmQf48ZM/seedbx-logo.png", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://i.postimg.cc/rmQf48ZM/seedbx-logo.png", Type: conf.TypeString, Group: model.STYLE},
