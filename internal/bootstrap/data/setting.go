...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "MadLad File", Type: conf.TypeString, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://cdn.discordapp.com/avatars/546797199527247874/0855b0c076f9a5ba0753ebc600c63f5c.png", Type: conf.TypeText, Group: model.STYLE},
